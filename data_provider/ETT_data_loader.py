...
class Solar(Dataset):
    """Solar-energy dataset (solar_AL.txt or .csv/.h5 variants). 60/20/20 split."""

    def __init__(self, root_path, flag='train', size=None, features='S', data_path='solar_AL.txt',
                 target='OT', scale=True, inverse=False, cols=None):
        if size is None:
            self.seq_len = 24 * 4 * 4
            self.label_len = 24 * 4
    ...
    def __read_data__(self):
        ...
        self.data_y = df_data.values[b1:b2] if self.inverse else data[b1:b2]
